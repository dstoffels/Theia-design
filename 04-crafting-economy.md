...
### Resources
Resources are nodes found in the wild where raw materials can be harvested.

#### Deposits
Deposits are finite resources of raw **minerals** that can be mined with viables tools, that directly correlate to the mineral they yield.

#### Trees
Trees can be chopped for wood and harvested for their seeds, sap and other byproducts. Cultivated trees in groves provide a constant source of these materials, while wild trees are finite resources.

**Skills**: Woodworking, Survival

| Tree | Action | Yield | Description |
| --- | --- | --- | --- |
| Tree | Chop | Wood, Trunk, Sap | Large, generic trees of varying species |
| Yew Tree | Chop | Yew | A flexible conifer used for making bows |
| Bamboo Clump | Chop | Bamboo | Tall stalks used for making bows & blowguns |
| Mulberry Tree | Harvest | Silk Filaments, Mulberries | A source of silk used for making fine textiles |

#### Plants
Plants are a renewable resource that yield seeds, fibers, food and alchemical materials. Wild sources have smaller yields, but the seeds can be used in gardens and plantations as a constant, high-yield source of the plant's yields. Plants that yield berries do not yield seeds and vice versa, berries can be used as seeds.

**Skills**: Survival

| Plant | Action | Yield | Description |
| --- | --- | --- | --- |
| Flax Plant | Harvest | Flax Fibers | A fibrous plant used for making linen and other textiles |
| Cannabis | Harvest | Hemp Fibers | A versatile plant used for making rope, textiles, and other materials |
| Gossypium | Harvest | Cotton Bolls, Cottonseed  | A soft, fluffy plant used for making textiles and clothing. |
| Avaram Senna | Harvest | Avaram, Avaram Seeds | A versatile shrub with a wide range of medicinal & alchemical uses |
| Rhus | Harvest | Rhus Berries | A shrub that produces berries used for alchemical purposes. |
| Emmer | Harvest | Grain | A versatile wheat for a variety of purposes |


#### Animals
Animals are a renewable resource that yield numerous fibers and byproducts when culled. Domesticable animals can be raised in corrals and paddocks to provide a constant, high-yield source of these materials. 

**Skills**: Husbandry, Survival

| Animal | Action | Yield | Domesticable | Description |
| --- | --- | --- | --- | --- |
| Auroch | Dress | Hide, Flesh, Bone | Yes | A large, wild bovine |
| Swine | Dress | Flesh, Bone | Yes | A large, wild hog |
| Karakul | Dress | Fleece, Flesh, Bone | Yes | A breed of sheep known for its fleece |
| Horse | Dress | Hide, Flesh, Bone | Yes | A domesticated animal used for riding and labor |
| Pukaloo | Dress | Hide, Flesh, Venom, Spiderdope | Yes | A giant, furry, poisonous arachnid that's very difficult to tame |

---

### Raw Materials
Raw materials are extracted directly from resource nodes and are often refined before crafting the final item.
...
| Brimstone      |                  |
| Salt           |                  |
| Chalcopyrite   | Copper Ingot, Bronze Ingot*  |
| Cassiterite    | Bronze Ingot*          |
| Argentite      | Silver Ingot*           |
| Calaverite     | Gold Ingot*             |
| Hematite       | Iron Ingot*, Steel Ingot*     |
| Hasperite      | Mithril Ingot*, Rolaren Ingot*|
...
| Material | Refined |
| --- | --- |
| Sap | Resin, Tannin*, Vitriol*, Urushi* |
| Flesh | Food, Sinew |
| Rhus Berries | Urushi* |
| Grain | Food  |
| Avaram |  |
...
### Refined Materials
Refined materials have been processed at a specialized station, often requiring multiple raw materials and minimum skill proficiency.
...
| --- | --- | --- | --- | --- |
| Copper | Kiln | Chalcopyrite, Charcoal | 0 | A soft, malleable metal used for basic tools and weapons |
...
| Silver | Kiln | Argentite, Charcoal | 50 | A precious metal used for crafting currency and magical items |
| Gold | Kiln | Calaverite, Charcoal | 50 | A highly valuable metal used for crafting currency and magical items |
...
| Resin | Alembic | Sap | 50 | A sticky, flammable substance used for waterproofing and adhesives |
| Tannin | Alembic | Wood, Sap | 50 | A bitter compound used for tanning leather and dyeing textiles |
| Vitriol | Alembic | Brimstone, Charcoal, Sap | 100 | A caustic compound used for crafting poisons |
| Urushi | Alembic | Rhus Berries, Charcoal, Sap | 150 | A lacquer used for waterproofing and hardening leather and wood |
...
## Equipment
Equipment items are crafted with a recipe of components and supplies. Some recipes are discovered through experimentation. Equipment can be disassembled to reclaim the components used to make them, allowing you to repurpose them into entirely different items.