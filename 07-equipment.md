...
- Short: 60-90cm. 3 ore.
- Medium: 90-120cm. 4 ore.
- Long: 120-150cm. 5 ore.
- Great: 150-180cm. 6 ore.
  
**Type**
The main component of a sword, which is fitted with a grip, and optional guard to form the weapon. When crafting, a new blade component can be shaped or existing blades reshaped into the following types:

- Thin: A narrow, flexible, double-edged blade, excels at quick, precise thrust attacks.
- Broad: A sturdy, double-edged blade, designed for slashing and durability.
- Curved: a single-edged blade with a gentle curve, ideal for slashing.
...
| Weapon          | Size   | Type    | Grip | Guard    | Pfcy| Wt   | Mat    | S | T | AP  | Unique | 
| --------------- | ------ | ------- | ---- | -------- | --- | ---- | ------ | - | - | --- | ------ |
| Gladius         | Short  | Mono    |      |          | 75  | 500  | Bronze | X | X | 20  |        |
| Khopesh         | Short  | Mono    |      |          | 50  | 800  | Bronze | X |   | 10  | Hook   | 
| Jian            | Medium | Mono    |      |          | 75  | 400  | Bronze | X | X | 40  |        |
| Spatha          | Short  | Broad   | 1    | Cross    | 100 | 200  | Iron   | X | X | 50  |        |
| Arming Sword    | Medium | Broad   | 1    | Cross    | 150 | 400  | Iron   | X | X | 50  |        |
| Bastard Sword   | Medium | Broad   | B    | Cross    | 150 | 600  | Iron   | X | X | 50  |        |
| Longsword       | Long   | Broad   | 2    | Cross    | 200 | 1800 | Iron   | X | X | 60  |        | 
| Montante        | Great  | Broad   | 2    | Cross    | 250 | 3000 | Iron   | X | X | 80  |        |
| Smallsword      | Short  | Thin    | 1    | Knuckle  | 100 | 200  | Iron   | X | X | 50  |        |
| Rapier          | Medium | Thin    | 1    | Basket   | 100 | 200  | Iron   | X | X | 50  |        |
| Estoc           | Long   | Thin    | 2    | Cross    | 200 | 1500 | Iron   |   | X | 100 |        |
| Wakizashi       | Short  | Curved  | 1    | Ring     | 200 | 900  | Iron   | X | X | 30  |        |
| Sabre           | Medium | Curved  | 1    | Knuckle  | 200 | 1200 | Iron   | X | X | 40  |        | 
| Katana          | Medium | Curved  | B    | Ring     | 200 | 1200 | Iron   | X | X | 40  |        | 
| Nodachi         | Long   | Curved  | 2    | Ring     | 200 | 1800 | Iron   | X | X | 50  |        | 
| Falchion        | Medium | Convex  | 1    | Knuckle  | 200 | 1800 | Iron   | X |   | 50  |        | 
| Dadao           | Medium | Convex  | B    | Cross    | 200 | 1800 | Iron   | X |   | 50  |        |
...
| --- | --- | --- |
| Arming Cap | Head | Cranium, Neck |
| Gambeson | Torso, Arms | Chest, Abdomen, Arms |
| Gloves | Hands | Hands |
| Cestus | Hands | Hands |
| Cuisses | Legs | Legs |
| Boots | Feet | Feet |
...
| Armor | Slots | Body Parts |
| --- | --- | --- |
| Coif | Head | Cranium, Neck |
| Byrnie | Torso, Arms | Chest, Abdomen |
| Hauberk | Torso, Arms | Chest, Abdomen, Arms |
| Mitons | Hands | Hands |
| Chausses | Legs | Legs |
...
| Armor | Slots | Body Parts |
| --- | --- | --- |
| Lorica Segmentata | Torso | Chest, Abdomen |
| Brigandine | Torso | Chest, Abdomen |
| Splint Bracers | Arms | Arms |
| Splint Greaves | Legs | Legs |

**Plate**
| Armor | Slots | Body Parts |
| --- | --- | --- |
| Helm | Head | Cranium |
| Bascinet | Head | Cranium |
| Heaume | Head | Cranium, Face, Neck |
| Cuirass | Torso | Chest, Abdomen |
| Bracers | Arms | Arms |
| Vambraces | Arms | Arms |
| Gauntlets | Hands | Hands |
| Greaves | Legs | Legs |
| Sabatons | Feet | Feet |
...
<!-- | Weapon | Difficulty | Weight | Reach | *Material | Unique |
| --- | --- | --- | --- | --- | --- |
